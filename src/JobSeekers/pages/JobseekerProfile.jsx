...
export const JobseekerProfile = () => {
  ...
  return (
    <>
      ...
      {showBio ? (
        <EditBio showBio={showBio} setShowBio={setShowBio} />
      ) : showPic ? (
        <EditPic showPic={showPic} setShowPic={setShowPic} />
      ) : null}
            ...
            <div className="grid mt-[2rem] md:grid-cols-2 md:gap-6">
              <div className="flex flex-col md:flex-row gap-x-[1rem]  items-center">
                ...
                <div className="">
                  ...
                  <small className="flex justify-center md:justify-start ">
                    <img src={marker} alt="" className="mr-[0.5rem]" />
              ...
              <div className="max-w-[600px] mt-[2rem] md:mt-0">
                <div className="flex justify-center md:justify-start">
                  <span className="font-[700] text-[18px]">Bio:</span>{" "}
                  <div

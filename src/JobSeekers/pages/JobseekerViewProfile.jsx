...
export const Profile = () => {
    ...
    return <>
        <Navbar user={user} />
        <section className='flex felx-wrap w-screen items-start gap-4'>
            <div className="flex flex-col gap-4 justify-start min-w-[60%] grow-[1] p-4">
                ...
                <div className="max-w-[52em] flex flex-col w-full rounded-lg border-grey border-2 p-4 gap-4">
                ...
                <div className="flex flex-col w-full max-w-[52em] rounded-lg border-grey border-2 p-4">
                    <header className="w-full flex items-center justify-between">
                ...
                <div className="flex flex-col w-full max-w-[52em] rounded-lg border-grey border-2 p-4">
                    ...
                    <div className="grow-1 w-full flex flex-wrap gap-4"></div>
                </div>
                <div className="flex flex-col w-full max-w-[52em] rounded-lg border-grey border-2 p-4">
                    <header className="w-full flex items-center justify-between">

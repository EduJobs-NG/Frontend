          ...
          <div className="flex uppercase py-[1.5rem] items-center flex-row justify-between">
            <ul className="flex gap-x-[3rem] text-white flex-row">
             <li className='title'>
              ...
              <li> 
              <NavLink to="#" className='p-1 cursor-pointer px-2'>DASHBOARD</NavLink>
              </li>
              <li>
              <NavLink to="#"   className='p-1 cursor-pointer px-2'>ANALYTICS</NavLink>
              </li>
              </div> 
            </ul>
            ...
            <ul className='hidden xl:flex flex-row text-white gap-x-[2rem]'>
              ...
              <li>
              <NavLink to="/"  className='p-1 cursor-pointer px-2'>I'm a job seeker</NavLink>
              </li>
              <li>
              <NavLink to="#" className='p-1 cursor-pointer px-2'>I'm an employer</NavLink>
              </li>
              <li>
              <NavLink to="#"   className='p-1 cursor-pointer px-4 border border-solid bg-white text-blue border-white rounded'>LOGIN</NavLink>
              </li>

...
export const FormInputBox = (props) => {
  const {label, placeholder, icon, className, disabled, value, onBlur, onChange, name,id, type} = props;
  ...
  return (
    <div className='relative'>
     ...
     {props.type!=='password' && (
      ...
      className={className} disabled={disabled} value={value} onBlur={onBlur} name={name} id={id} onChange={onChange} />

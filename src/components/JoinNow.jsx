...
export const JoinNow = ({ setShowModal }) => {
  return (
    <section className="border relative bg-white p-2 py-[5rem] px-[20px] mx-[1.5rem] md:px-[42px] rounded-[30px] md:rounded-[30px] max-w-[500px]">
      <div className="flex  my-3 pb-[3rem] gap-x-[0.2rem] justify-center items-center ">
        ...
        <FaTimes
          ...
          className="text-blue z-[99999] text-[1.3rem] font-[400] absolute top-[1rem] right-[1rem] md:right-[1rem]  cursor-pointer"
        />
      </div>

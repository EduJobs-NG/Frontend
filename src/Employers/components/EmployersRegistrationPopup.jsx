...
import { EmployersRegistration } from '../pages/EmployersRegistration';

export const EmployersRegistrationPopup = ({setShowRegister}) => {
      ...
      <div className="relative  w-auto my-6 mx-3 max-w-3xl">
        ...
        <div className="">
          ...
          <div className="p-6 relative  flex-auto">
                <EmployersRegistration showModal={showModal} setShowRegister={setShowRegister}  />
   </div>      

...
export const Hero = () => {
  return (
    ...
    >
      ...
      <p className='mx-[5%] z-10 text-[clamp(1em,2.2vw,6em)] w-[max(60%,20em)] leading-[1.2em]  sm:mb-0'>
        Save time and money on recruitment with EduJobs matchmaking
        technology and Candidates' assessement.
      </p>
      <Link to='/employer/register' 
      className='uppercase mx-[5%] my-4 z-10 bg-white self-start text-blue p-2  px-12 rounded font-bold  sm:block hover:bg-blue hover:text-white transition-all ease'
      >
        start hiring
      </Link>
    </section>

        ...
        <div className='absolute left-0 top-0 w-full z-[9999] xl:hidden'>
          <div data-aos="fade-up" className='bg-white  transition duration-1000 ease-in-out h-screen flex flex-col align-items justify-center  text-center '>
            ...
            <ul className='py-[2rem] flex flex-col '>
              ...
              <Link data-aos-delay="300" data-aos="fade-left" className=" font-[700] text-[1.2rem] mb-[33px]" to="#">ABOUT US</Link>
            </ul>
            <div className='container mx-auto'>
            ...
            <ul className='py-[2rem] flex flex-col'>
              <Link data-aos-delay="300" data-aos="fade-left" className="text-blue text-[1.2rem] uppercase mb-[45px] font-[700]" to="/employer">I'm a job seeker</Link>
            </ul>
            <div>
